<%-- 
    Document   : product
    Created on : 9 Feb, 2019, 6:19:11 AM
    Author     : user
--%>
...
<html>
 ...
 <form action="prodaction.jsp">
            <center>
                <table>
                    <tr>
                        
                        <td>Product Code:</td>
                        <td><input type="text" name="n1" required="yes"/></td>
                    </tr>
                    <tr>
                        <td>Product Name:</td>
                        <td><input type="text" name="n2" required="yes"/></td>
                        
                    </tr>
                    <tr>
                        <td>Category:</td>
                        <td><input type="text" name="sub1" value="<%=request.getParameter("cat")%>" required="yes"/></td>
                    </tr>
                    <tr>
                        <td>Sub Category:</td>
                        <td><input type="text" name="sub2" value="<%=request.getParameter("id")%>" required="yes" />
                        </td>
                    </tr>
                    <tr>
                        <td>Brand:</td>
                    ...
                    <tr>
                        <td>Description:</td>
                        <td><textarea name="ta1" cols="23" rows="10" required="yes"></textarea>
                        </td>    
                    </tr>
                    <tr>
                        <td>Amount:</td>
                        <td><input type="nymber" name="t9" required="yes"/>
