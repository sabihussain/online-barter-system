                ...
                <div class="container">
                    <div class="row text-center">
                        ...
                        String amt=request.getParameter("amt");
                            ...
                            ResultSet rs = DB.executeQuery("select * from product where pcat='" + cat 
                                    + "' and pcode not in(select pcode from orders) and pcode not in(select pcode from exchange) and uid =" + session.getAttribute("uid"));
                            while (rs.next()) {
                        %>
                        <h2>Product Selected-<%=sub%></h2>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
                            <div style="background-color: #cc00cc">
                                ...
                                <h2> <a href="payact_1.jsp?id=<%=rs.getString("pcode")%>&pc=<%=sub%>" class="content-link"> EXCHANGE</a></h2>
