                    ...
                    <div class="row text-center">
                        ...
                        <%
                            ...
                            String cat = request.getParameter("cat");
                                 ResultSet r1 = DB.executeQuery("select * from product where pcat='" + cat + "' and subcat='" + sub + "' and pcode not in(select pcode from orders) and pcode not in(select pcode from exchange) and uid!="+session.getAttribute("uid"));
                           if(r1.next()){
                            ResultSet rs = DB.executeQuery("select * from product where pcat='" + cat + "' and subcat='" + sub + "' and pcode not in(select pcode from orders) and pcode not in(select pcode from exchange) and uid!="+session.getAttribute("uid"));
                            while (rs.next()) {
                        %>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
                            <div style="background-color: #ffcccc">
                                ...
                                <h2> <a href="pay.jsp?id=<%=rs.getString("pcode")%>" class="content-link">BUY </a></h2>
