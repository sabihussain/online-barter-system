...
<center><h1 style="background-color: rgba(0,0,0,0.8);width:500px">DEALER'S BAY</h1></center>
                        ...
                        <div class="col-sm-6">
                            <div class="blog-content">
                                ...
                                <table border="2">
                                    ...
                                    <%
                                        System.out.println("select * from product inner join orders on orders.pcode=product.pcode inner join register on register.id=orders.uid where orders.uid=" + session.getAttribute("uid"));
                                        ResultSet rs = DB.executeQuery("select * from product inner join orders on orders.pcode=product.pcode inner join register on register.id=orders.uid where orders.uid=" + session.getAttribute("uid"));
                                        while (rs.next()) {
                                    %>
                                    <tr>
                                        <td>
                        ...
                        <div class="col-sm-6">
                            <div class="blog-content">
                                <img src="img/1-2.jpg" alt="Image">
                                 ...
                                 <h2>Exchanging Orders Status</h2>
                                <table border="2">
                                    <tr>
                                        <th>&nbsp;Product Code&nbsp;</th>
                                        <th>&nbsp;Product Name&nbsp;</th>
 ...
 <th>&nbsp;Status&nbsp;</th>
                                    ...
                                    <%
                                        System.out.println("select * from product inner join exchange on orders.pcode=product.pcode inner join register on register.id=orders.uid where exchange.uid=" + session.getAttribute("uid"));
                                        ResultSet rs1 = DB.executeQuery("select * from product inner join exchange on exchange.pcode=product.pcode inner join register on register.id=exchange.uid where exchange.uid=" + session.getAttribute("uid"));
                                        while (rs1.next()) {
                                    %>
                                    <tr>
                                        <td>
                                        ...
                                        <td> &nbsp;<%=rs1.getString("pname")%>&nbsp;
                                         ...
                                         <td> &nbsp;<%=rs1.getString("epcode")%>&nbsp;<br/>
                                             <%
                                             ResultSet r1=DB.executeQuery("select * from product where pcode='"+rs1.getString("epcode")+"'");
                                             r1.next();
                                             %>
                                             &nbsp;<%=r1.getString("pname")%>&nbsp;<br/>
                                        </td>
