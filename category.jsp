                ...
                <div class="row text-center">
                    <div class="col-sm-12">
                        <div class="footer-content">
                            <center>
        <form action="cataction.jsp">
            <table>
                <tr>
                    <td>Category:</td> </tr>
                <tr>
                    <td><input type="text" name="cat" required="yes"/></td>
                </tr>
                <tr>
                ...
                while(rs.next())
                    ...
                    <tr>
                        ...
                        <td>&nbsp; <%= rs.getString("cat")%>
                       &nbsp; </td>
                      <td>&nbsp;<a href="del.jsp?id=<%=rs.getString("cid")%>">Delete</a>&nbsp;</td> 
                    <td>&nbsp;<a href="subcategory.jsp?id=<%=rs.getString("cat")%>">Sub Category</a>&nbsp;</td>
                   </tr>
                       <% } %>
            </table>
