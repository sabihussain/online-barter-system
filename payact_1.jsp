...
out.println("Product Amount Difference is"+cc+"Do you wish to continue?");

%>
<a href="payact_1_1.jsp?id=<%=pc%>&pc=<%=c%>" class="content-link">Yes! Continue</a>
<br/>
<br/>
<a href="user.jsp">No Do Not Continue</a>
<br/>
<br/>