                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
                            <div style="background-color: #0033cc">
                                <%
                                    if (request.getParameter("c").equals("p")) {
                                %>
                                <h2> <a href="product.jsp?id=<%=rs.getString("subcategory")%>&cat=<%=rs.getString("cat")%>" class="content-link"> <%=rs.getString("subcategory")%></a></h2>

                                &nbsp;
                                <%} else if (request.getParameter("c").equals("e")) {%>
                                <h2> <a href="viewpro.jsp?id=<%=rs.getString("subcategory")%>&cat=<%=rs.getString("cat")%>" class="content-link"> <%=rs.getString("subcategory")%></a></h2>

                                &nbsp;
                                <%} else if (request.getParameter("c").equals("b")) {%>
                                <h2> <a href="viewpro_1.jsp?id=<%=rs.getString("subcategory")%>&cat=<%=rs.getString("cat")%>" class="content-link"> <%=rs.getString("subcategory")%></a></h2>
